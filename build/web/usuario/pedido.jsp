        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid" align="center" id="desplieguepedido">
                <div class="col-md-5" align="center" id="desc-ped">
                    ...
                    <div class="row" align="center">
                        ...
                        <div class="col-xs-4"><label >Combinacion</label></div>
                        <div class="col-xs-2"><label >Pares</label></div>
                        <div class="col-xs-1"><label >Precio</label></div>
                    </div>
                    <%
                            int cont = 0;
                            int pares = 0;
                            ...
                            for (int i = 0; i < cor.size(); i++) {
                                ...
                                out.print("<div class=\"row espacioparavta \" align=\"center\">"
                                        ...
                                        + "<div class=\"col-xs-2 letraparavta\"><label >" + cor.get(i).getEstilo() + "</label></div>"
                                        + "<div class=\"col-xs-4 letraparavta\"><label >" + cor.get(i).getCombinacionchar() + "</label></div>"
                                        + "<div class=\"col-xs-2 letraparavta\" align=\"center\"><label>" + pares + "</label></div>"
                                        + "<div class=\"col-xs-2 letraparavta\" align=\"center\"><label>" + cor.get(i).getPrecio() + "</label></div>"
                                        + "</div>");
                                total += pares * cor.get(i).getPrecio();
                                pares = 0;
                            }
                        } else
                            out.print("<div class=\"letrapedidofalso\"><label class=letratotal>El Pedido esta vacio!</label></div>");
                    %>
                </div>
                <%if (!dis.isEmpty()) {
                ...
                %>
                <div class="row">
                    <h1>Total: <%=formateador.format(total)%> MXN</h1>
                </div>
            </div>
            ...
            <div class="row espaciobtn">
                ...
                <div align="center">
                    ...
                    <input type="checkbox" id="serie" name="serie">
            ...
            <script>
                ...
                function ocultarVentanas()
                {
                    ...
                    var aa= document.getElementById("alabel");
                    if(aa!=null){
                        location = "index.jsp";
                    }
            ...
            <div id="miVentana" style="position: fixed; width: 70%; height: 30%; top: 0; left: 0; font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; background-color: #FAFAFA; color: white; display:none;">
                <div class="row " style="background-color: #616185;padding-left: 2%;padding-right: 2%;border-radius: 10px;">
                    ...
                    <a class="btn" onclick="refresh()"><img src="../images/refresh.png" width="50" height="50"></a>
                    <div class="espacio1"> <!-- Cliente -->
                        <div class="col-md-10 espas col-md-offset-1" id="get_catalogo" align="center">
                            <!--<div class="col-md-offset-4">
                                <div class="col-md-6"><label>Fecha Entrega:</label><div class=""><input class="form-control" type="text" id="fe" value="<%=fechac%>"></div></div>
                            </div>-->
                            ...
                            <div class="" style="padding-top: 5%" id="refe">
                                <div class="col-md-12"><label>Cliente:</label><div id="cli"><select class="form-control"  ></select></div></div>
                            </div>
                            <div class="" style="padding-top: 10%">
                                <div class="col-md-12"><label>Observaciones:</label><div class=""><input class="form-control" type="text" id="obs"></div></div>
                            </div>
                            <div style="padding-top: 10%">
                                <button class="btn btn-danger" onclick="dopedido()">Finalizar Pedido</button>
                            </div>
                            <div class="" style="padding-top: 5%">
                                <div class="col-md-12" id="resp"></div>
                            </div>
                        </div> 
                    </div>
                </div>

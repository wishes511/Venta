        ...
        <footer>
            <div align="center">
                <div class="col-sm-3 espacio">
                    ...
                    <label class="shiro">(476) 6890 130 | (476) 5870 067</label><br>
                    <label class="shiro">Descarga app android</label><br>
                    <a href="Venta.apk"><img src="images/android.png" width="150" height="50" alt="" class="img-responsive"></a>
                    <br>
                    <hr style="">
                </div>
                <div class="col-sm-3 espacio">
                    ...
                    <label class="shiro"><a class="shiro" href="https://www.dutygearmexico.com">Duty Gear</a></label><br>
                    <label class="shiro">Duty Gear Industry</label><br>
                    <label class="shiro">Duraland</label><br>
                    <label class="shiro">Traffic</label><br>
                    <label class="shiro">TopSuelas</label><br>
                    <hr>
                </div>
                <div class="col-sm-3 espacio" >
                ...
                <div class="col-sm-3 espacio">
                    ...
                    <label class="shiro titulos">Escanea para descargar la app</label><br><img class="img-responsive jumbismini" src="images/QR.png" width="75px" height="75px"><br>
